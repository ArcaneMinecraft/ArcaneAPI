...
public enum BungeeCommandUsage {
    ...
    BADGE           ("badge", "[hide|reset|prefix priority|prefix name]", null, "Change your tag - click on text to select", "b", "prefix"),
    BADGEADMIN      ("badgeadmin", "<clear|list|reset|set|setpriority|settemp> [player] ...", "arcane.command.badgeadmin", "Administrative options for player tags", "ba", "nt"),
    FINDPLAYER      ("findplayer", "<part of name>", "arcane.command.findplayer", "Find player name from part of name", "find"),
    FIRSTSEEN       ("firstseen", "[player]", "arcane.command.seen", "Get the date when player first joined the game", "seenfirst", "fseen", "seenf"),
    SEEN            ("seen", "[player]", "arcane.command.seen", "Get the date when player last left the game"),
    ...
    DISCORD         ("discord", "[link [<Discord name> <token>]|unlink]", "arcane.command.links"),
    REDDIT          ("reddit", "[link <Reddit name>|unlink]", "arcane.command.links"),
    LIST            ("list"),
